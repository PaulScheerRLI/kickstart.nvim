  ...
  config = function()
    require('zk').setup {
      ...
      vim.keymap.set('n', '<leader>zc', function()
        ...
        local ok, word = pcall(vim.fn.input, 'Create or edit Zettel: ', default_word)
        if not ok or word == '' then
          return
        end -- user cancelled or empty input
        vim.cmd('ZkNew {title="' .. word .. '"}')
      end, { desc = 'Zettel Create :ZkNew with word under cursor' }),
    }
  end,
}
